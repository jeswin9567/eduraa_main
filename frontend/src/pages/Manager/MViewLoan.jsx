...
const MVLoanDetails = () => {
    ...
    return (
        <div>
            <MVLHeader />
            <div className='manln-container'>
            <Managersidebrcom />
            <div className="manln-loan-details">
                <h1>{loan.loanName}</h1>
                
                <div className="manln-section-heading">Bank Information</div>
                ...
                <div className="manln-section-heading">Loan Details</div>
                ...
                <div className="manln-button-container">
                    <button className="manln-back-button" onClick={() => navigate(-1)}>Back</button>
                    <button className="manln-delete-button" onClick={handleDelete}>Delete</button>
                    <button className="manln-update-button" onClick={() => navigate(`/mupdateloan/${id}`)}>Update</button>
                </div>
            </div>
            </div>
        </div>
